    ...
    <div className="mx-auto max-w-full px-5 md:px-[40px] xl:px-[100px] 2xl:px-[100px] text-(--Livsee-champagne) pt-[40] pb-[40] bg-(--Livsee-emerald) text-white py-8 px-4">
        ...
        <div className="">
            <Image
                ...
                priority
                />
            <p className="mt-[15px] md:mt-[15px] xl:mt-[15px] 2xl:mt-5 max-w-3xl text-[16px] md:text-[16px] 2xl:text-[18px] leading-[1.4]">Ann Arbor, Michigan</p>
        </div>
        ...
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2">       
            ...
            <div className="">
            <div className="">
                <h5 className="font-serif mt-[20px] md:mt-[30px] 2xl:mt-[36px] text-[20px] md:text-[20px] 2xl:text-[24px] leading-[1.2]">Write Us</h5>
                ...
                <div className="w-full left-0">
                    <div className="w-[280px] sm:max-w-md sm:ml-auto sm:w-[365px]">
                    <h5 className="font-serif mt-[10px] md:mt-[30px] 2xl:mt-[36px] text-[24px] md:text-[22px] 2xl:text-[24px] leading-[1.2]">The Livsee Newsletter</h5>
                    <p className="mb-[12px] md:mb-[15px] xl:mb-[15px] 2xl:mb-5 mt-[10px] md:mt-[20px] xl:mt-[20px] 2xl:mt-[20px] max-w-3xl text-[16px] md:text-[16px] 2xl:text-[18px] leading-[1.4]">Follow our journey.</p>
                        <div className="flex items-center border bg-white rounded-full ">
                            <input
                            type="email"
                            placeholder="Subscribe with your email"
                            className="h-[48px] md:h-full w-full p-3 bg-transparent text-(--Livsee-emerald) outline-none text-[14px] md:text-[16px] "
                            />
                            <button className="px-3 py-3 bg-(--Livsee-emerald) text-white rounded-full hover:bg-[#507360] hover:text-(--Livsee-champagne) m-1 cursor">                           
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 mx-auto max-w-full md:px-[40px] xl:px-[100px] 2xl:px-[100px] bg-[color:var(--Livsee-champagne)] pt-[15px] pb-[15px]">
        <p className="text-[14px] text-[#7a755f] leading-none text-center md:text-left">
            ...
            <div className="flex gap-2 text-right justify-center md:justify-end lg:justify-end xl:justify-end 2xl:justify-end">              
                <a href="/privacy_policy" className="text-(--Livsee-emerald) hover:text-black text-[14px] leading-none">
                    Privacy
                </a> 
                <span className="text-(--Livsee-emerald) leading-none">|</span>
                <a href="/terms_and_conditions" className="text-(--Livsee-emerald) hover:text-black text-[14px] leading-none">
                    Terms &amp; Conditions
                </a>          
            </div>
        </div>
